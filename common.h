...
public:
	...
	optdesc.add_options()
	    ...
	    ("num-realizations,M", progopts::value<int>(&M)->default_value(1),
	     "Specify the number of simulation runs. The final answer is the average of "
	     "all runs. The default is one.")
